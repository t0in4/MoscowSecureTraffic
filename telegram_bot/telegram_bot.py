...
def start_command_handler(update, context):
    ...
    quiz_question.question = "Каким должен быть пароль?"
    quiz_question.answers = ["qwerty1234", "adminadmin", generate_random_password()]
    quiz_question.correct_answer_position = 2
    quiz_question.correct_answer = quiz_question.answers[2]
